...
public class UserController {
    ...
    @Timed(value = "users.signUp", longTask = true)
    @PostMapping("/sign-up")
    ...
    @Timed(value = "users.login", longTask = true)
    @PostMapping("/login")
    ...
    @Timed(value = "users.appleLogin", longTask = true)
    ...
    @Timed(value = "users.guestLogin", longTask = true)
    ...
    @Timed(value = "users.checkEmail", longTask = true)
    ...
    @Timed(value = "users.checkNickName", longTask = true)
    ...
    @Timed(value = "users.withdrawal", longTask = true)
    ...
    @Timed(value = "users.putProfile", longTask = true)
    @PutMapping("/profile")
    @PreAuthorize("hasAnyRole('USER')")
    ...
    @Timed(value = "users.getProfile", longTask = true)
    @GetMapping("/profile")
    @PreAuthorize("hasAnyRole('USER')")
    ...
    @Timed(value = "users.passwordEmail", longTask = true)
    ...
    @Timed(value = "users.passwordCode", longTask = true)
    ...
    @Timed(value = "users.changePassword", longTask = true)
    @PutMapping("/password")
    ...
    @Timed(value = "users.blockUser", longTask = true)
